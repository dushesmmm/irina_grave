...
import image1 from "../../../public/images/design in progress/design in progress 1/project image 1.jpg";
import image2 from "../../../public/images/design in progress/design in progress 2/project image 1.jpg";

const projects = [
  {
    id: 1,
    title: "Квартира для большой семьи 138 кв. метров",
    description:
    ...
    link: "/",
    image: image1,
    category: "КВАРТИРА | МОСКВА, ЖК LUCKY",
  },
  {
    id: 2,
    title: "Дом на никольской слободе 850 кв. метров ",
    description:
      "Заказчики, семья с двумя детьми, искали в Москве большую квартиру — не менее 300 метров. И уже на этапе поисков советовались с дизайнером. «Таких больших квартир на рынке немного. Мы вместе смотрели планировки и оценивали, можно ли получить из них то, что необходимо, в частности, спальни для всех членов членов семьи, каждую со своим санузлом и гардеробными», — рассказывает Ирина.",
    link: "/",
    image: image2,
    category: "ДОМ | МОСКОВСКАЯ ОБЛАСТЬ  ",
  },
];
